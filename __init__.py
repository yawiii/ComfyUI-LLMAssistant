...
# 导入节点类
from ollama_assistant import OllamaPromptAssistant
from api_assistant import APIPromptAssistant

# 定义节点映射
NODE_CLASS_MAPPINGS = {
    "OllamaPromptAssistant": OllamaPromptAssistant,
    "APIPromptAssistant": APIPromptAssistant
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "OllamaPromptAssistant": "LLM提示词助手（Ollama）",
    "APIPromptAssistant": "LLM提示词助手（API）"
}

# 声明插件的安全配置
NODE_CLASS_SECURITY_MAPPINGS = {
    "OllamaPromptAssistant": {"level": "normal", "api_keys_required": ["OPENAI_API_KEY"]},
